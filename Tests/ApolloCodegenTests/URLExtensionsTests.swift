...
class URLExtensionsTests: XCTestCase {
  ...
  func testIsDirectoryForExistingDirectory() {
    ...
    XCTAssertTrue(FileManager.default.apollo.existsAsDirectory(atPath: parentDirectory.path))
  ...
  func testIsDirectoryForExistingFile() {
    ...
    XCTAssertTrue(FileManager.default.apollo.existsAsFile(atPath: currentFileURL.path))
  ...
  func testIsSwiftFileForNonExistentFileWithSingleExtension() {
    ...
    XCTAssertFalse(FileManager.default.apollo.existsAsFile(atPath: doesntExist.path))
